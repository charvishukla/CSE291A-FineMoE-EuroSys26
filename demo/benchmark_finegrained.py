...
if __name__ == "__main__":
    ...
    print(f"\nInitializing model in FINE-GRAINED (Prefetch) mode (prefetch_distance = {prefetch_distance})...")
    ...
    run_benchmark(
        ...
        max_new_tokens=max_new_tokens, output_log_file="finegrained_benchmark_log.json"
    )
    print("\n--- Fine-grained benchmark complete. ---")